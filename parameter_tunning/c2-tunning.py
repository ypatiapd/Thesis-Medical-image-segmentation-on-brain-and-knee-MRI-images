...
file_handler = logging.FileHandler('second_c2_tunning.log')
...
#filename39=['strip13','strip01','strip33','strip28','strip04','strip23','strip16'] # 93
...
#filename01=['strip13','strip39','strip28','strip33','strip23','strip32','strip16']#,'strip22'] # 90
#nonsimilar
#filename01=['strip12','strip17','strip29','strip05','strip26','strip38']#,'strip16'] # 90
#filenames.append(filename01)

#filename12=['strip04','strip05','strip20','strip29']#,'stripp20','stripp29'] 95
#filenames.append(filename12)

#filename28=['strip01','strip33','strip13','strip39','strip22','strip23','strip04']#,'strip20'] #92
#filenames.append(filename28)

#filename22=['strip33','strip04','strip29','strip05','strip20','strip38','strip17']#,'strip26']#,'strip23','strip04']#,'strip20'] #87
#ssim
#filename22=['strip33','strip16','strip12','strip17','strip29','strip04','strip05']#,'strip26']#,'strip23','strip04']#,'strip20'] #87
#filenames.append(filename22)
#MI
#filename22=['strip02','strip26','strip28','strip33','strip39','strip38']#,'strip05']#,'strip26']#,'strip23','strip04']#,'strip20'] #87
#filenames.append(filename22)

#filename02=['strip22','strip26','strip38','strip04','strip33','strip20']#,'strip17']#,'strip26']#,'strip23','strip04']#,'strip20'] #93
#filenames.append(filename02)

#filename33=['strip22','strip38','strip04','strip20','strip23','strip28']#,'stripped04','stripped26']#,'stripped39'] #90
#filenames.append(filename33)

#filename32=['strip16','strip23','strip33','strip22','strip04','strip01']#,'stripped04','stripped26']#,'stripped39'] #87
#nonsimilar
#filename32=['strip02','strip26','strip38','strip05','strip29','strip28']#,'strip20']#,'stripped04','stripped26']#,'stripped39'] #87
#filenames.append(filename32)

#filename25=['strip38','strip14','strip29','strip09','strip07','strip05']#,'stripped04','stripped26']#,'stripped39'] #90
#filenames.append(filename25)

#filename16=['strip32','strip04','strip22','strip20','strip17','strip33']#,'stripped04','stripped26']#,'stripped39'] #90
#filenames.append(filename16)

#filename21=['strip16','strip14','strip39','strip32','strip13','strip07']#,'stripped04','stripped26']#,'stripped39'] #90
...
'''target_filenames.append('stripped06')
target_filenames.append('stripped07')
target_filenames.append('stripped09')
target_filenames.append('stripped14')'''
#target_filenames.append('strip12')
'''target_filenames.append('stripped13')
target_filenames.append('stripped16')
target_filenames.append('stripped17')
target_filenames.append('stripped20')'''
...
for item in range(0,len(target_filenames)):
    ...
    ss = np.random.choice(len(Y2)-263, size=len(Y2)-263, replace=False)  #pairnoume megalutero dianysma apo oso xreiazomaste gia na apofugoume ta error logw deikth ite
    ...
    for i in range(0,B):
        ...
        ss = np.random.choice(len(Y1)-263, size=len(Y1)-263, replace=False)  
    ...
    for c_val in c_values:
        ...
        for i in classes:
            ...
            for k in range (0,iterations):  # k number of iterations , hopefully convergence
                ...
                for j in range(0,B): 
                    ...
                    print('best_c ='+format(c_params[0]))
                    param= parameter(string)'''
                    param = parameter('-s 2 -c '+str(c_val))  # na mhn pesei katw apo 10 to -c, palia 100
        ...
        '''print('Results for c1 value :'+str(c_val))
        ...
        logger.info('Results for c2 value :'+str(c_val))
