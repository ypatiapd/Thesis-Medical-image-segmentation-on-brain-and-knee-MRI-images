# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 10:24:36 2023
...
filename23=['strip33','strip33','strip32','strip32','strip22','strip22','strip07','strip07','strip04','strip04']#,'strip39'] # 90
filenames.append(filename23)
...
for item in range(0,len(target_filenames)):
    ...
    for i in range(0,utrain_size):
        ...
        ulabeled_x1.append(temp)
        ulabeled_y1.append(Y2[ss[i]])
    ...
    for i in range(0,utrain_size):
       ...
       # temp[28]=X2[ss[i]][28] #TotalEnergy
        ...
        ulabeled_x2.append(temp)
        ulabeled_y2.append(Y2[ss[i]])
            #ulabeld_y.append(copy.copy())
    ...
    for i in classes:
        ...
        for h in range(0,B):  #train B weak annotators on labeled data and predict on unlabeled data
            ...
            if h%2==0:
                ulabeled_x=ulabeled_x1
                ulabeled_y=ulabeled_y1
                test_x=test_x1
                test_y=test_y1
                ...
                ulabeled_x=ulabeled_x2
                ulabeled_y=ulabeled_y2
                test_x=test_x2
                test_y=test_y2
                for j in range(0,len(labeled_x)):
