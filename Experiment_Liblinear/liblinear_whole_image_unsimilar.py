# -*- coding: utf-8 -*-
"""
Created on Sun Apr  2 17:00:04 2023
...
file_handler = logging.FileHandler('liblinear_B3_mae_22feat_unsimilar.log')
...
filename01=['strip34','strip37','strip25']#,'strip33','strip16']#,'strip22']#,'strip16','strip22']
filenames.append(filename01)

filename02=['strip27','strip13','strip21']#,'strip04','strip33']#,'strip25']#,'strip25','strip07']
filenames.append(filename02)

filename04=['strip13','strip27','strip21']#,'strip14','strip22']#,'strip17']#,'strip05','strip25']#,'strip33','strip26'] # 90
filenames.append(filename04)

filename05=['strip27','strip13','strip21']#,'strip14','strip22']#,'strip04']#,'strip04','strip09'] # 90
filenames.append(filename05)

filename06=['strip28','strip13','strip21']#,'strip09','strip05']#,'strip37']#,'strip05','strip37'] # 90
filenames.append(filename06)

filename07=['strip01','strip21','strip13']#,'strip34','strip25']#,'strip09']#,'strip09','strip37'] # 90
filenames.append(filename07)

filename09=['strip01','strip13','strip21']#,'strip14','strip37']#,'strip07']#,'strip17'] # 90
filenames.append(filename09)

filename12=['strip13','strip27','strip21']#,'strip22','strip17']#,'strip37']#,'strip37'] # 90
filenames.append(filename12)

filename13=['strip06','strip25','strip37']#,'strip33','strip22']#,'strip16']#,'strip04'] # 90
filenames.append(filename13)

filename14=['strip28','strip13','strip01']#,'strip25','strip38']#,'strip07']#,'strip29'] # 90
filenames.append(filename14)

filename16=['strip25','strip06','strip27']#,'strip20','strip30']#,'strip17']#,'strip33'] # 90
filenames.append(filename16)

filename17=['strip13','strip21','strip27']#,'strip04','strip22']#,'strip20']#,'strip20'] # 90
...
filename21=['strip13','strip27','strip21']#,'strip13','strip07']#,'strip34']#,'strip34'] # 90
filenames.append(filename21)

filename22=['strip39','strip27','strip21']#,'strip20','strip38']#,'strip17']#,'strip17']#,'strip26','strip07']
...
filename25=['strip21','strip01','strip13']#,'strip09','strip07']#,'strip05']#,'strip05'] # 90
...
filename27=['strip12','strip21','strip16']#,'strip25','strip33']#,'strip09']#,'strip09'] # 90
filenames.append(filename27)

filename28=['strip34','strip06','strip21']#,'strip39','strip22']#,'strip04']#,'strip04'] # 90
...
filename33=['strip37','strip27','strip21']#,'strip20','strip07']#,'strip28']#,'strip07'] # 90
filenames.append(filename33)

filename34=['strip28','strip01','strip13']#,'strip25','strip37']#,'strip09']#,'strip09'] # 90
filenames.append(filename34)

filename37=['strip28','strip01','strip13']#,'strip34','strip09']#,'strip38']#,'strip38'] # 90
filenames.append(filename37)

filename38=['strip28','strip13','strip21']#,'strip14','strip09']#,'strip05']#,'strip26'] # 90
filenames.append(filename38)

filename39=['strip06','strip17','strip12']#,'strip28','strip04']#,'strip23']#,'strip26'] # 90
