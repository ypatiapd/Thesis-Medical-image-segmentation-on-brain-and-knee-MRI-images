# -*- coding: utf-8 -*-
"""
Created on Mon Mar 27 11:55:44 2023
...
file_handler = logging.FileHandler('liblinear_B3_mae.log')
...
for item in range(0,len(target_filenames)):
    ...
    for i in classes:
        ...
        for h in range(0,B*annotators):  #train B weak annotators on labeled data and predict on unlabeled data
        ...
        for j in range(0,annotators*B): # number of annotators hence number of mixing coeffs
                mi.append(1/(annotators*B))  #warm start
        ...
        for k in range (0,iterations):  # k number of iterations , hopefully convergence
            ...
            for j in range(0,annotators*B): # fix the w tilde back to w 
            ...
            for j in range(0,annotators*B): #compute the mis of the next iteration with the norms equasion  li et al 
    ...
    del sample_x,sample_y,samples,X1,Y1,selected_indices,selected_class_labels,selected_feature_vectors,x_coords,y_coords
