# -*- coding: utf-8 -*-
"""
Created on Mon Mar 27 11:40:34 2023
...
file_handler = logging.FileHandler('libsvm_B3_mae.log')
...
for item in range(0,len(target_filenames)):
    ...
    for i in classes:
        ...
        for h in range(0,B):  #train B weak annotators on labeled data and predict on unlabeled data
            ...
            param = svm_parameter('-t 2 -g 0.01 -c 4') #s=1 gia dual problem ,-C gia na vrei to kalitero c
