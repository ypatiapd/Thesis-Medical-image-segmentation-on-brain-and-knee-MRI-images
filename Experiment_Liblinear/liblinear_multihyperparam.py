# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 15:58:09 2023
...
file_handler = logging.FileHandler('liblinear_test.log')
...
'''filename01=['strip13','strip39','strip28','strip33','strip23','strip32','strip16']#,'strip22']
filenames.append(filename01)

#filename01=['strip13','strip13','strip39','strip39','strip28','strip28','strip33','strip33']#'strip23','strip32','strip16']#,'strip22']
#filenames.append(filename01)

filename02=['strip22','strip26','strip38','strip09','strip04','strip33','strip25']#,'strip07']
filenames.append(filename02)

#filename02=['strip22','strip22','strip26','strip26','strip38','strip38','strip09','strip09']#'strip04','strip33','strip25']#,'strip07']
#filenames.append(filename02)

filename04=['strip09','strip20','strip38','strip14','strip22','strip17','strip05']#,'strip25']#,'strip33','strip26'] # 90
filenames.append(filename04)

#filename04=['strip09','strip09','strip20','strip20','strip38','strip38','strip14','strip14']#'strip22','strip17','strip05']#,'strip25']#,'strip33','strip26'] # 90
#filenames.append(filename04)

filename05=['strip38','strip07','strip25','strip14','strip29','strip22','strip04']#,'strip09'] # 90
filenames.append(filename05)

filename06=['strip38','strip25','strip07','strip26','strip09','strip29','strip05']#,'strip37'] # 90
filenames.append(filename06)

filename07=['strip38','strip14','strip29','strip05','strip34','strip25','strip09']#,'strip37'] # 90
filenames.append(filename07)

#filename07=['strip38','strip38','strip14','strip14','strip29','strip29','strip05','strip05','strip34','strip34']#,'strip25','strip25']#,'strip34','strip25']#,'strip09','strip37'] # 90
#filenames.append(filename07)

filename09=['strip25','strip04','strip38','strip14','strip37','strip07','strip17'] # 90
filenames.append(filename09)

filename12=['strip04','strip29','strip20','strip05','strip22','strip17','strip37'] # 90
filenames.append(filename12)

filename13=['strip01','strip39','strip28','strip33','strip32','strip23','strip22'] # 90
...
filename17=['strip14','strip37','strip09','strip29','strip04','strip22','strip20'] # 90
filenames.append(filename17)

filename19=['strip13','strip39','strip01','strip33','strip28','strip22','strip04']#,'strip26'] #na vgei
filenames.append(filename19)

filename20=['strip04','strip22','strip38','strip09','strip33','strip17','strip29'] # 90
filenames.append(filename20)

filename21=['strip16','strip14','strip39','strip32','strip13','strip07','strip34'] # 90
filenames.append(filename21)

filename22=['strip33','strip04','strip29','strip05','strip20','strip38','strip17']#,'strip26','strip07']
filenames.append(filename22)

filename23=['strip33','strip32','strip22','strip07','strip04','strip01','strip39'] # 90
filenames.append(filename23)

filename25=['strip38','strip37','strip14','strip29','strip09','strip07','strip05'] # 90
...
filename27=['strip38','strip07','strip26','strip34','strip25','strip33','strip09'] # 90
filenames.append(filename27)

filename28=['strip01','strip33','strip13','strip39','strip22','strip23','strip04'] # 90
...
filename33=['strip22','strip38','strip04','strip20','strip26','strip23','strip07'] # 90
filenames.append(filename33)

filename34=['strip14','strip38','strip07','strip25','strip37','strip29','strip09'] # 90
filenames.append(filename34)

filename37=['strip25','strip14','strip29','strip17','strip34','strip09','strip38'] # 90
filenames.append(filename37)

filename38=['strip25','strip07','strip29','strip34','strip14','strip09','strip26'] # 90
...
filename40=['strip14','strip34','strip07','strip17','strip29','strip21','strip38'] # 90
filenames.append(filename40)

filename42=['strip19','strip04','strip33','strip22','strip05','strip30','strip26'] # 90
filenames.append(filename42)
...
target_filenames.append('strip19')
...
target_filenames.append('strip40')
target_filenames.append('strip42')
    ...
    for i in classes:
        ...
        for h in range(0,B):  #train B weak annotators on labeled data and predict on unlabeled data
            ...
            '''if h%2 == 0:
                ...
                param = parameter('-s 1 -c 10') #s=1 gia dual problem ,-C gia na vrei to kalitero c
            '''
