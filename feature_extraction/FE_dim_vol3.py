...
#a.SetRegionOfInterest([60,68,60,30,34,30])
...
for z in range(0,4):
    ...
    if z<2: #z<2
        ...
        principalDf = pd.DataFrame(data = principalComponents
                     , columns = [str(4*z+2), str(4*z+3), str(4*z+4), str(4*z+5)])#,str(7*z+6),str(7*z+7),str(7*z+8)])#,str(10*z+9),str(10*z+10),str(10*z+11)])
        ...
        del df
            ...
            principalComponents = pca.fit_transform(df)
            principalDf = pd.DataFrame(data = principalComponents
                         , columns = [str(4*z+2), str(4*z+3)])#, str(10*z+4), str(10*z+5),str(10*z+6),str(10*z+7),str(10*z+8),str(10*z+9),str(10*z+10),str(10*z+11)])
        ...
        df_im = pd.DataFrame(df.loc[:,0:1].values,columns = [str(0), str(1)])
        df = df.loc[:,2:len(featlist[z])].values
        df = StandardScaler().fit_transform(df)
        ...
        principalComponents = pca.fit_transform(df)
        principalDf = pd.DataFrame(data = principalComponents
                     , columns = [str(4*z), str(4*z+1)])#, str(6*z+4), str(6*z+5),str(6*z+6),str(6*z+7)])#,str(8*z+8),str(8*z+9)])
