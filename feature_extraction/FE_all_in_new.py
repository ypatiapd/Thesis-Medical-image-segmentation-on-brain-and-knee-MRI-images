# -*- coding: utf-8 -*-
"""
Created on Mon Jan  9 16:33:01 2023
    ...
    for z in range(0,len(featlist)):
        ...
        if z<len(featlist)-1: #z<2
            ...
            principalDf = pd.DataFrame(data = principalComponents
                         , columns = [str(4*z+6), str(4*z+7), str(4*z+8),str(4*z+9)])#,str(7*z+10),str(7*z+11),str(7*z+12)])#,str(10*z+9),str(10*z+10),str(10*z+11)])
            ...
            df_im = pd.DataFrame(dataset.loc[:,0:5].values,columns = [str(0), str(1) , str(2),str(3), str(4) , str(5)])#,str(6),str(7)]) #stin teleutaia epanalipsi pairnw tis treis prwtes steiles pou einai oi klaseis, to brightness kai lbp 
