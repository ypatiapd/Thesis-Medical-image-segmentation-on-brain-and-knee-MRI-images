...
for ite in imgs:   
    imageName='D:/norm_imgs/norm9019287.hdr'
    #imageName='C:/Users/ypatia/diplomatiki/registered_imgs/registered'+ite+'.hdr'

    maskName  = 'D:/registered_imgs/9019287/mask.hdr'
    ...
    a.SetRegionOfInterest([15,74,101,116,203,157]) # slack ROI for all Images in imgs : [106, 79, 20, 253, 272, 126]    #a.SetRegionOfInterest([60,72,60,88,104,44])   #anapoda oi akrianes diastaseis sti maska !!!!!!!!!!!!!!!!!!!!!!!
    ...
    for z in range(0,len(featlist)):
       ...
       '''
        ...
        for l in range(1,len(dataset[0])):
            ...
            plt.figure(4)
            plt.hist(class4,bins=100,color='purple')
