...
filename01=['strip13','strip39','strip28','strip33','strip23','strip32','strip16']
filenames.append(filename01)

filename02=['strip22','strip26','strip38','strip09','strip04','strip33','strip25']
filenames.append(filename02)

filename04=['strip09','strip20','strip38','strip14','strip22','strip17','strip05'] # 90
filenames.append(filename04)

filename05=['strip38','strip07','strip25','strip14','strip29','strip22','strip04'] # 90
filenames.append(filename05)

filename06=['strip38','strip25','strip07','strip26','strip09','strip29','strip05'] # 90
filenames.append(filename06)

filename07=['strip38','strip14','strip29','strip05','strip34','strip25','strip09'] # 90
...
filename30=['strip29','strip37','strip14','strip04','strip34','strip05','strip07'] # 90
filenames.append(filename30)

filename31=['strip21','strip16','strip30','strip37','strip09','strip14','strip34'] # 90
    ...
    for i in classes:
        ...
        for k in range (0,iterations):  # k number of iterations , hopefully convergence
            ...
            for j in range(0,B): 
                ...
                print('best_c ='+format(c_params[0]))
                param= parameter(string)'''
                param = parameter('-s 2 -c 0.2 ')  # na mhn pesei katw apo 10 to -c, palia 100
